...
route::get('/listarServicios', [serviciosadController::class, 'contratarPersonas'])->name('ver.servicios');
...
Route::get('/inicio/contratar', [FacturaController::class, 'contratar'])->name('contratar');
